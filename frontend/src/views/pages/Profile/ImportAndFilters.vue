    ...
    <div v-else>
      ...
      <div class="p-float-label mt-4">
        <InputText
          ...
          type="text"
          id="feed_url"
          v-model="profile.settings.feed.url"
      ...
      <span class="p-float-label mt-4">
        <InputText
          ...
          type="text"
          id="login"
          v-model="profile.settings.feed.login"
          @change="$emit('onChange')"
        />
      ...
      <span class="p-float-label mt-4">
        <InputText
          ...
          type="text"
          id="password"
          v-model="profile.settings.feed.password"
          @change="$emit('onChange')"
        />
      ...
      <span class="p-float-label mt-4">
        <InputNumber
          class="w-full"
          id="min_count"
          v-model="profile.settings.feed.min_count"
          mode="decimal"
          @input="$emit('onChange')"
        />
      ...
      <Rules
        ...
        :objectLink="profile.settings.import"
      ...
      <div class="switch">
        <InputSwitch
          ...
          v-model="profile.settings.fields.is_custom"
          :binary="true"
        />
        <label for="use_custom_fields"
          >Использовать тонкую настройку полей</label
        >
      </div>
      ...
      <div class="mt-4" v-if="profile.settings.fields.is_custom">
        <div class="switch">
          <InputSwitch
            id="is_csv_number"
            v-model="profile.settings.fields.is_csv_number"
            @change="$emit('onChange')"
            :binary="true"
          />
          <label for="is_csv_number"
            >Использовать нумерацию столбцов вместо названия (для .CSV)</label
          >
        </div>

        <CustomFields
          :numbersOnly="profile.settings.fields.is_csv_number"
          :profileLink="profile"
